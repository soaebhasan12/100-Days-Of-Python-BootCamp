...
Original file is located at
    https://colab.research.google.com/drive/1OPMfoekK72BuXvlwkknqiSJaR5fUEZs-
...
df_data = pd.read_csv('nobel_prize_data-8.csv')
...
print(separated_values[0].max())
print(separated_values[1].max())
